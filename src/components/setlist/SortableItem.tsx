  ...
  const CardContent = (
    ...
    `}>
      ...
      <div className="flex items-center justify-center w-16 shrink-0">
        {isEditMode ? (
          // 編集モード: ドラッグハンドル
          <div {...attributes} {...listeners} className="text-gray-400 cursor-grab active:cursor-grabbing p-2 touch-none outline-none">
          ...
          entry.song.key !== 0 ? (
            ...
            <span className="text-[10px] font-bold text-gray-500 px-2 py-1 opacity-50">
              原キー
            </span>
          )
        )}
