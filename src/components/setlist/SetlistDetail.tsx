  ...
  return (
    <div className="pb-20">
          ...
          <div className="flex items-center gap-1 z-10 w-24">
            {isEditMode ? (
              <button
                ...
                className="text-sm font-bold text-primary px-2 py-1 transition-colors"
              >
                完了
              </button>
            ) : (
          ...
          <div className="ml-auto z-10 w-24 flex justify-end">
            {isEditMode ? (
              <button
                ...
                className={`p-2 rounded-full transition-colors ${selectedIds.length > 0 ? "text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20" : "text-muted-foreground/50"}`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
              ...
              <button
                onClick={handleBack}
                className="p-2 -mr-2 text-muted-foreground hover:text-foreground rounded-full hover:bg-muted transition-colors block"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
      ...
      <div className="pt-16">
        ...
        {items.length === 0 && (
          <div className="text-center py-10 text-muted-foreground font-bold transition-colors">
            曲がありません。
            <br />
            左上の「＋」ボタンで追加してね！
          </div>
