  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-amber-50 p-4">
      <div className="bg-white max-w-md w-full p-8 rounded-2xl shadow-lg">
        <h1 className="text-2xl font-bold text-center text-gray-800 mb-6">おかえりなさい！</h1>
          ...
          <div>
            ...
            <div className="relative">
              <input 
                ...
                required
                className="w-full border p-3 rounded-lg outline-none focus:ring-2 focus:ring-amber-400 pr-10"
                value={password} 
        ...
        <div className="mt-6 text-center text-sm">
          まだアカウントがない？ <Link href="/signup" className="text-blue-500 underline">新規登録</Link>
        </div>
      </div>
    </div>
  );
