    ...
    <div className="max-w-2xl mx-auto pb-20 px-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-card p-6 rounded-xl shadow-sm border border-border space-y-6 transition-colors">
        ...
        <div className="bg-muted/30 p-4 rounded-xl border border-border-light relative">
          <label className="block text-sm font-medium text-foreground mb-1">YouTube URL <span className="text-muted-foreground text-xs ml-2 font-normal">※任意</span></label>
          <div className="flex flex-col sm:flex-row gap-2">
            <input {...register("youtubeUrl")} type="text" placeholder="https://youtu.be/..." 
              className={`flex-1 min-w-0 bg-background text-foreground border rounded-lg px-4 py-2 focus:ring-2 outline-none transition-colors placeholder:text-muted-foreground ${
                errors.youtubeUrl ? "border-red-500 focus:ring-red-200" : "border-border focus:ring-ring"
              }`} 
            />
            <button
              type="button"
          ...
          <p className="text-xs text-muted-foreground mt-2 font-bold leading-relaxed">
            💡 URLを入れて自動入力ボタンを押すと、曲名とアーティストが自動で埋まるよ！<br />
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex-1">
            ...
            <input {...register("title")} type="text" placeholder="例: 怪獣の花唄" 
              className={`w-full bg-background text-foreground border rounded-lg px-4 py-2 focus:ring-2 outline-none transition-colors placeholder:text-muted-foreground ${
                errors.title ? "border-red-500 focus:ring-red-200" : "border-border focus:ring-ring"
              }`} 
            />
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 sm:rotate-90">
          ...
          <div className="flex-1">
            ...
            <input {...register("artist")} type="text" placeholder="例: Vaundy" 
              className={`w-full bg-background text-foreground border rounded-lg px-4 py-2 focus:ring-2 outline-none transition-colors placeholder:text-muted-foreground ${
                errors.artist ? "border-red-500 focus:ring-red-200" : "border-border focus:ring-ring"
              }`} 
            />
